...
export default function Achievements() {
  ...
  // Get the 3rd card from certificates (index 2)
  const achievement = certificates[2];
  ...
  return (
    <section id="achievements" className="py-24 relative overflow-hidden bg-darker/30">
      <div className="container mx-auto px-6 max-w-7xl relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold"><span className="text-gradient">Achievements</span></h2>
        </motion.div>
        ...
        <div className="flex justify-center items-center">
          ...
          >
            ...
            <div className="p-6 flex-grow flex flex-col gap-3 relative">
              ...
              <h3 className="text-xl font-bold text-white group-hover:text-primary transition-colors leading-tight pr-8">{achievement.title}</h3>
              <p className="text-sm font-semibold text-secondary">{achievement.issuer}</p>
              <p className="text-gray-400 text-sm line-clamp-3 my-2 flex-grow">{achievement.description}</p>
