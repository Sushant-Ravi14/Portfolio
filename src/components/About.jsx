        ...
        >
          <div className="glass-card p-8 md:p-10 mb-8 backdrop-blur-xl">
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-400 leading-relaxed text-lg">
                On the frontend, I focus on crafting visually stunning and highly responsive interfaces using modern tools like React and Tailwind CSS. My foundation in HTML5, CSS3, and JavaScript allows me to bring creative designs to life, ensuring that every interaction is smooth and every layout is intuitive across all devices.
              </p>
              <p className="text-gray-400 leading-relaxed text-lg">
                When it comes to the backend, I enjoy architecting robust systems and managing data efficiently. My experience with Node.js and Express enables me to build high-performance APIs, while my proficiency in both NoSQL (MongoDB) and SQL (MySQL) databases ensures that I can handle complex data requirements with ease.
              </p>
              <p className="text-gray-400 leading-relaxed text-lg">
